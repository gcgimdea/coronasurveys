...
# bold_if_decreasing <- function(x, xl, xh, y, yl, yh) {
...
bold_if_increasing <- function(x, xl, xh, y, yl, yh) {
  return (paste0(print_value(x), " [",
                 print_value(xl), ",",
                 print_value(xh), "] & ",
                 print_value(y), " [",
                 print_value(yl), ",",
...
for (i in seq(1,nrow(df))) {
  ...
  cat( bold_if_decreasing(df$p_pos_RF_1[i], df$p_pos_RF_1[i]-df$p_pos_RF_1_error[i], df$p_pos_RF_1[i]+df$p_pos_RF_1_error[i],
                          df$p_pos_RF_2[i], df$p_pos_RF_2[i]-df$p_pos_RF_2_error[i], df$p_pos_RF_2[i]+df$p_pos_RF_2_error[i]))
  cat(" & ")
  
  cat( bold_if_decreasing(df$efficacy_RF_1[i], df$efficacy_RF_1_low[i], df$efficacy_RF_1_high[i],
...
for (i in seq(1,nrow(df))) {
  ...
  cat( bold_if_decreasing(df$efficacy_RF_vac1dose_1[i], df$efficacy_RF_vac1dose_1_low[i], df$efficacy_RF_vac1dose_1_high[i],
                         df$efficacy_RF_vac1dose_2[i], df$efficacy_RF_vac1dose_2_low[i], df$efficacy_RF_vac1dose_2_high[i]))
  cat(" & ")
 
  cat( bold_if_decreasing(df$efficacy_RF_vac2doses_1[i], df$efficacy_RF_vac2doses_1_low[i], df$efficacy_RF_vac2doses_1_high[i],
