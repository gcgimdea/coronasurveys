...
Scatter_plot_vaccines_efficacy <- function() {
  ...
  # plot_2 <- ggplot(df_to_plot, aes(x= efficacy_RF_2, y= prev_omicron)) +#aes(x= prev_omicron, y= efficacy_RF_2)) +
  #   geom_point(colour="black") +
  #   geom_errorbarh(data = df_to_plot,
  #                  aes(xmin = efficacy_RF_2_low,
  #                      xmax = efficacy_RF_2_high,
  #                      y = prev_omicron)) +
  # 
  #   geom_errorbar(data = df_to_plot,
  #                 aes(ymin = prev_omicron_low,
  #                     ymax = prev_omicron_high,
  #                     x = efficacy_RF_2)) +
  # 
  ...
  #                                              segment.color = 'red',
  #                                              size = 6) +
  #   labs(x ="Vaccination efficacy", y = "Prevalence Omicron") +#labs(x = "Prevalence Omicron", y = "Vaccination efficacy") +
  #   # stat_summary(fun.df_to_plot=mean_cl_normal) +
  #   geom_smooth(method='loess', formula=y~x,se = FALSE) +
  #   theme(axis.text=element_text(size=16),
  #                                    axis.title=element_text(size=20)) + xlim(ymin,ymax)
  ...
  # plot_3 <- ggplot(df_to_plot, aes(x= efficacy_RF_vac1dose_2, y= prev_omicron)) + #aes(x= prev_omicron, y= efficacy_RF_vac1dose_2)) +
  #   geom_point(colour="black") +
  #   geom_errorbarh(data = df_to_plot,
  #                  aes(xmin = efficacy_RF_vac1dose_2_low,
  #                      xmax = efficacy_RF_vac1dose_2_high,
  #                      y = prev_omicron)) +
  # 
  #   geom_errorbar(data = df_to_plot,
  #                 aes(ymin = prev_omicron_low,
  #                     ymax = prev_omicron_high,
  #                     x = efficacy_RF_vac1dose_2)) +
  # 
  #   geom_label_repel(aes(label = country_name),
  #                                               box.padding   = 0.5,
  #                                               point.padding = 0.75,
  #                                               segment.color = 'red',
  #                                               size = 6) +
  #   labs(x = "Vaccination efficacy 1 dose", y = "Prevalence Omicron") +
  #   # stat_summary(fun.df_to_plot=mean_cl_normal) +
  #   geom_smooth(method='loess', formula=y~x,se = FALSE) +
  #   theme(axis.text=element_text(size=16),
  #                                    axis.title=element_text(size=20)) + xlim(ymin,ymax)
  ...
  # plot_4 <- ggplot(df_to_plot, aes(x= efficacy_RF_vac2doses_2, y= prev_omicron)) + #aes(x= prev_omicron, y= efficacy_RF_vac2doses_2)) +
  #   geom_point(colour="black") +
  #   geom_errorbarh(data = df_to_plot,
  #                  aes(xmin = efficacy_RF_vac2doses_2_low,
  #                      xmax = efficacy_RF_vac2doses_2_high,
  #                      y = prev_omicron)) +
  # 
  #   geom_errorbar(data = df_to_plot,
  #                 aes(ymin = prev_omicron_low,
  #                     ymax = prev_omicron_high,
  #                     x = efficacy_RF_vac2doses_2)) +
  # 
  #   geom_label_repel(aes(label = country_name),
  #                                                box.padding   = 0.5,
  #                                                point.padding = 0.75,
  #                                                segment.color = 'red',
  #                                                size = 6) +
  #   labs(x = "Vaccination efficacy 2 doses", y = "Prevalence Omicron") +
  #   # stat_summary(fun.df_to_plot=mean_cl_normal) +
  #   geom_smooth(method='loess', formula=y~x,se = FALSE) +
  #   theme(axis.text=element_text(size=16),
  #                                    axis.title=element_text(size=20)) + xlim(ymin,ymax)
