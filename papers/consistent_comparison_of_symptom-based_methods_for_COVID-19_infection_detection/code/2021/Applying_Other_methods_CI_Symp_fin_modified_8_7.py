...
def Boostraping_others_methods(df,df_is,n_iterations):
    ...
    for i in range(n_iterations):
        ...
        Df_try_55, Df_try_65, Df_try_55_No_Na, Df_try_65_No_Na,y_test_55, y_test_65, y_test = Israel_preparation(test_x_is,test_y_is) 
...
for i in countries:
    ...
    if(i == "AU"):
        ...
        df_DE_other_Metrics.to_csv("df_CA_other_Metrics_CI_Symp_fin.csv")
        print("Fin " + str(i))
    elif(i == "DE"):
        df_DE_other_Metrics.to_csv("df_DE_other_Metrics_CI_Symp_fin.csv")
        print("Fin " + str(i))
    elif(i == "JP"):
        df_DE_other_Metrics.to_csv("df_JP_other_Metrics_CI_Symp_fin.csv")
        print("Fin " + str(i))
    elif(i == "ZA"):
        df_DE_other_Metrics.to_csv("df_ZA_other_Metrics_CI_Symp_fin.csv")
    elif(i == "BR"):
        df_DE_other_Metrics.to_csv("df_BR_other_Metrics_CI_Symp_fin.csv")
