...
def Israel_preparation(X,Y):
    ...
    Df_try_65 = X[["B1_2.1","B1_1.1","B1_7.1","B1_3.1","B1_12.1","age_65","E3.1","B5.1"]]
    Df_try_55 = X[["B1_2.1","B1_1.1","B1_7.1","B1_3.1","B1_12.1","age_55","E3.1","B5.1"]]
    y_test = Y
    #Dropping NA
...
for i in countries:
    ...
    if(i == "AU"):
        ...
        df_DE_other_Metrics.to_csv("df_CA_Zoabi_Metrics_CI_Symp_2020.csv")
        print("Fin " + str(i))
    elif(i == "DE"):
        df_DE_other_Metrics.to_csv("df_DE_Zoabi_Metrics_CI_Symp_2020.csv")
        print("Fin " + str(i))
    elif(i == "JP"):
        df_DE_other_Metrics.to_csv("df_JP_Zoabi_Metrics_CI_Symp_2020.csv")
        print("Fin " + str(i))
    elif(i == "ZA"):
        df_DE_other_Metrics.to_csv("df_ZA_Zoabi_Metrics_CI_Symp_2020.csv")
    elif(i == "BR"):
        df_DE_other_Metrics.to_csv("df_BR_Zoabi_Metrics_CI_Symp_2020.csv")
