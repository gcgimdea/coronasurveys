...
from standard_predictor_.xprize_predictor import XPrizePredictor
from standard_predictor_.xprize_predictor import NPI_COLUMNS
...
DATA_FILE = os.path.join(ROOT_DIR, '../../../data/oxford/country', "AL-estimate.csv")
...
def generate_cases_and_stringency_for_prescriptions(start_date, end_date, prescription_file, costs_file):
    ...
    pres_df = predictor.load_original_data(prescription_file)
    pred_dfs = {}
