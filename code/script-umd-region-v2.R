...
responses_path2020 <- "../data/estimates-symptom-survey/experimental/aggregates2020/region/"
responses_path2021 <- "../data/estimates-symptom-survey/experimental/aggregates2021/region/"
...
cols_to_use <- c("ISO2",	"ISO_3",	"country_agg",	"region_agg", "date",	"first_date",	"count",	
